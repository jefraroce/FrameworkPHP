<form action="index" method="post" id="city_form">
    ...
    <input type="hidden" id="id" name="city[id]" value="<?php echo (isset($params['id']) ? $params['id'] : "" ); ?>" />
    <label for="code">CODE</label>&nbsp;
    <input type="number" id="code" name="city[code]" min="1" size="6" placeholder="code" value="<?php echo (isset($params['code']) ? $params['code'] : "" ); ?>" class="required" />
    <br/><br/>
